...
if(not RELOAD):
    with open(f'/home/jovyan/RNAModif/rnamodif/data_utils/experiment_files_precompute.pkl','rb') as f:
        experiment_files = pickle.load(f)
    ...
    with open('/home/jovyan/RNAModif/rnamodif/data_utils/experiment_files_precompute.pkl', 'wb') as f:
        print('SAVING NEW EXPERIMENT FILES DICT')
        pickle.dump(experiment_files, f)

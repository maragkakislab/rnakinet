...
rule run_all_R10_inference:
    input: 
        pod5_files = lambda wildcards: f'{DATA_DIR}/experiments_allR10/{wildcards.experiment_name}',
        model_path = get_model_path,
    output:
        csv_path = OUTPUTS_DIR + '/R10_exp_predictions/{model_name}/{experiment_name}/preds.csv',
    conda:
        "../envs/inference.yaml"
    params:
        batch_size = lambda wildcards: MODEL_INFERENCE_PARAMS[wildcards.model_name]['batch_size'],
